...
<head>
    ...
    <style>
        ...
        input, select, textarea { box-sizing: border-box; width: 100%; padding: 10px 12px; border: 1px solid #d1d5db; border-radius: 8px; }
    ...
    <nav>
        ...
        <div>
            @auth
                ...
                <a href="{{ route('quests.generate.create') }}">生成任务</a>
